...
//            Toast.makeText(context, "No clicked - Action cancelled", Toast.LENGTH_SHORT).show();
   ...
   public static void showEditCrmPopupLine(Context context, Report report, List<CircuitBreaker> circuitBreakerList,
    ...
    //------------------------------------- history edit popups -------------------------------
    public static void showEditCustomerPopupHistory(Context context, Report report, EditPopupListener editPopupListener) {
        // Inflate custom layout
        LayoutInflater inflater = LayoutInflater.from(context);
        View customView = inflater.inflate(R.layout.layout_edit_customer_details, null);
        ...
        btnSave.setOnClickListener(v -> {
            ...
            if (Utility.validateEditText(etCustomerName) &&
                ...
                Utility.saveReportHistory(context, report);
                editPopupListener.savedCustomerDetails();
                dialog.dismiss();
    ...
    public static void showEditSitePopupHistory(Context context, Report report, EditPopupListener editPopupListener) {
        // Inflate custom layout
        LayoutInflater inflater = LayoutInflater.from(context);
        View customView = inflater.inflate(R.layout.layout_edit_site_details, null);
    ...
    public static void showEditIrPopupGroundHistory(Context context, Report report, EditPopupListener editPopupListener) {
        // Inflate custom layout
        LayoutInflater inflater = LayoutInflater.from(context);
        View customView = inflater.inflate(R.layout.layout_edit_ir_test_ground, null);
    ...
    public static void showEditIrPopupLineHistory(Context context, Report report, EditPopupListener editPopupListener) {
        // Inflate custom layout
        LayoutInflater inflater = LayoutInflater.from(context);
        View customView = inflater.inflate(R.layout.layout_edit_ir_test_line, null);
    ...
    public static void showEditTripPopupLineHistory(Context context, Report report, List<CircuitBreaker> circuitBreakerList,
                                             int index,EditPopupListener editPopupListener) {
        // Inflate custom layout
        LayoutInflater inflater = LayoutInflater.from(context);
        View customView = inflater.inflate(R.layout.layout_edit_trip_test, null);
    ...
    public static void showEditCrmPopupLineHistory(Context context, Report report, List<CircuitBreaker> circuitBreakerList,
                                            int index,EditPopupListener editPopupListener) {
        // Inflate custom layout
        LayoutInflater inflater = LayoutInflater.from(context);
        View customView = inflater.inflate(R.layout.layout_edit_crm_test, null);
