...
public class FragmentReportHistoryDetails extends Fragment {
    ...
    public FragmentReportHistoryDetails() {
        // Required empty public constructor
    }

    public static FragmentReportHistoryDetails newInstance(String param1, String param2) {
        FragmentReportHistoryDetails fragment = new FragmentReportHistoryDetails();
