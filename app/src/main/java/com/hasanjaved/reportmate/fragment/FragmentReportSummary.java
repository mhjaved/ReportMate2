...
import com.hasanjaved.reportmate.utility.DirectoryCreator;
...
//                DirectoryCreator.createFolderInDocuments(context,
//                        BASE_FOLDER_NAME + "/" + equipmentName + "/" + IrTest + "/" + IrTest1_AG + "/" + Pictures);
