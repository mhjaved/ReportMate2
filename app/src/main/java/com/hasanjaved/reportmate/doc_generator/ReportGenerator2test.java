...
//
//
//public class ReportGenerator2test  extends AsyncTask<Object,String ,String> {
//
//
//    @Override
//    protected void onPreExecute() {
//        super.onPreExecute();
////        publishProgress(new ReportGenerationTask.ProgressUpdate(0, "Starting report generation..."));
//    }
//
//    @Override
...
////            publishProgress(new ReportGenerationTask.ProgressUpdate(10, "Creating document..."));
//
//            XWPFDocument document = new XWPFDocument();
//
////            publishProgress(new ReportGenerationTask.ProgressUpdate(20, "Adding titles..."));
//            createDocumentTitles(document, report);
//
////            publishProgress(new ReportGenerationTask.ProgressUpdate(30, "Creating main table..."));
//            createExactReportTable(document, report);
//
////            publishProgress(new ReportGenerationTask.ProgressUpdate(60, "Processing images..."));
//
...
////            publishProgress(new ReportGenerationTask.ProgressUpdate(70, "Adding panel images..."));
////            addImageSectionWithProgress(document, "Panel general images", dbBoxImages, dbBoxTitles);
//
//            publishProgress(new ReportGenerationTask.ProgressUpdate(80, "Adding IR test images..."));
//            addImageSectionWithProgress(document, "MCCB & MCB: IR Test and Results", irTestImages, irTestLabels);
//
//            publishProgress(new ReportGenerationTask.ProgressUpdate(90, "Saving document..."));
//
//            // Save document
////            String savedPath = saveDocumentSync(context, document, reportName);
//
////            publishProgress(new ReportGenerationTask.ProgressUpdate(100, "Report completed!"));
//
//            return savedPath;
//
//        } catch (Exception e) {
...
//
////    @Override
////    protected void onProgressUpdate(ReportGenerationTask.ProgressUpdate... values) {
////        super.onProgressUpdate(values);
////        ProgressDialog dialog = dialogRef.get();
////        if (dialog != null && values.length > 0) {
////            ReportGenerationTask.ProgressUpdate update = values[0];
...
//        setCellText(row14.getCell(0), "MFG.:", false, ParagraphAlignment.LEFT);
//        setCellText(row14.getCell(4), "CURVE NO.: 1.5 to 10 Times of Full Load Current", false, ParagraphAlignment.LEFT);
//        setCellText(row14.getCell(8), "CURVE RANGE:", false, ParagraphAlignment.LEFT);
//
...
//        setCellText(row15.getCell(0), "MFG.:", false, ParagraphAlignment.LEFT);
//        setCellText(row15.getCell(4), "CURVE NO.: Type -B", false, ParagraphAlignment.LEFT);
//        setCellText(row15.getCell(8), "CURVE RANGE: 2 to 16 Times of Full Load Current", false, ParagraphAlignment.LEFT);
//
...
//        setCellText(row16.getCell(8), "CURVE RANGE", false, ParagraphAlignment.LEFT);
//
