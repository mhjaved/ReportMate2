...
public class CrmTestHistoryRecyclerAdapter extends RecyclerView.Adapter<CrmTestHistoryRecyclerAdapter.MyViewHolder> {
    ...
    public CrmTestHistoryRecyclerAdapter(Context context, List<CircuitBreaker> list, int selectedItem, EditRecyclerViewClickListener recyclerViewClickListener) {
...
//    return 3;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView ivArrow,ivResult,ivConnection,ivEdit;
